...
public class DungeonGame {
    ...
    public int calculateMinimumHP(int[][] dungeon) {
        ...
        search(cells.get(0).get(0), new Path());
    ...
    public void buildGrid(int[][] dungeon) {
        ...
        System.out.println("Cells have been built");
    }

    public void search(Cell cell, Path path) {
        ...
        if (cell.down != null) {
            ...
            search(cell.down, newPathDown);
        }

        if (cell.right != null) {
            Path newPathRight = new Path(path);
            search(cell.right, newPathRight);
        }
